...
data_path = project_path / 'data' / 'output' / 'reduce_cell_9_power' / '2023_04_12'
rcp_data = data_path
cells_turned_down = []
...
df_cells_all_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/centre_v2_scenario_all_cells.feather'
)
...
df_cells_power_reduced_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/centre_v2_scenario_variable_cells.feather'
)
...
df_cells_power_static_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/centre_v2_scenario_static_cells.feather'
)
