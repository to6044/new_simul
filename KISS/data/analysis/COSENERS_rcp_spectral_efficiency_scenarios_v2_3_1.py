...
# Convert `spectral_efficiency_mean` from Mbps/J to bps/J
for df in dataframes:
    df['spectral_efficiency_mean'] = df['spectral_efficiency_mean'] * 1000000
    df['spectral_efficiency_std'] = df['spectral_efficiency_std'] * 1000000
...
# # # Set the y limits
# ax.set_ylim(bottom=1.7, top=2.06)
# ax1.set_ylim(bottom=1.7, top=2.06)
...
fig_filename = f'{date_str}_rcp_spectral_efficiency_scenarios_v2_3_2.pdf'
