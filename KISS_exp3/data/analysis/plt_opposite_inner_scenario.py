...
df_cells_all_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/opposite_inner_scenario_all_cells.feather'
)
...
df_cells_power_reduced_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/opposite_inner_scenario_variable_cells.feather'
)
...
df_cells_power_static_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/opposite_inner_scenario_static_cells.feather'
)
...
# Set figure title
fig.suptitle('Impact of reducing cell 8 and cell 10 output power (dBm) on the network', fontsize=16)
...
fig_filename = f'{date_str}_r2irp_cell_{reduced_cells_str}_power_dBm_v3_0.pdf'
