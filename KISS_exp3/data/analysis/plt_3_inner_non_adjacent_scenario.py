...
df_cells_all_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/inner_non_adjacent_scenario_all_cells.feather'
)
...
df_cells_power_reduced_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/inner_non_adjacent_scenario_variable_cells.feather'
)
...
df_cells_power_static_stats_per_power_level_dBm.to_feather(
    f'{project_path_str}/data/analysis/GLOBECOM/inner_non_adjacent_scenario_static_cells.feather'
)
